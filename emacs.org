...
- When we want the text accepted over the suggest completion use "C-M-j" which executes (ivy-immediate-done) [[https://emacs.stackexchange.com/questions/32862/ivy-disable-completion-for-a-command-in-minibuffer][source]]
#+begin_src emacs-lisp
  (use-package ivy
    :after counsel
    :defer t
...
** TODO Haskell
*** 1) Install [[https://www.haskell.org/ghcup/][GHCup]]
...
*** Modify Themes
**** General Org
#+begin_src emacs-lisp :tangle ~/.emacs.d/themes/jmn-gruvbox-general-org-theme.el
...
**** Dark
***** Hard
#+begin_src emacs-lisp :tangle ~/.emacs.d/themes/jmn-gruvbox-dark-hard-theme.el
...
#+end_src
***** Hardest
#+begin_src emacs-lisp :tangle ~/.emacs.d/themes/jmn-gruvbox-dark-hardest-theme.el
...
#+end_src
***** Medium
#+begin_src emacs-lisp :tangle ~/.emacs.d/themes/jmn-gruvbox-dark-medium-theme.el
...
**** Light
***** Hard
#+begin_src emacs-lisp :tangle ~/.emacs.d/themes/jmn-gruvbox-light-hard-theme.el
...
#+end_src
***** Medium
#+begin_src emacs-lisp :tangle ~/.emacs.d/themes/jmn-gruvbox-light-medium-theme.el
...
#+end_src
***** Soft
#+begin_src emacs-lisp :tangle ~/.emacs.d/themes/jmn-gruvbox-light-soft-theme.el
...
*** Modifying Themes
**** Light
#+begin_src emacs-lisp :tangle ~/.emacs.d/themes/jmn-light-theme.el
(deftheme jmn-light
...
#+end_src
**** Wombat
#+begin_src emacs-lisp :tangle ~/.emacs.d/themes/jmn-wombat-theme.el
(deftheme jmn-wombat
