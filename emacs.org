...
*** tags
can sort todos in agenda by using selecting =m= in org-agenda
=@dev, @home, @office, @travelling, @phone, @email, @errands=
Contexts?

*** archive
- =C-c C-x C-a=   : org-archive-subtree-default places heading in <bufName>_archive
* Terminals
** vterm
