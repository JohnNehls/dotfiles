...
*** Transparency
Set general function which works all the time-- even in full screen
#+begin_src emacs-lisp
...
Set default: alpha-background is great in version 29 but I could not get it to work in Emacs 29
#+begin_src emacs-lisp :tangle no
